...
interface Api {
    ...
    @Multipart
    @POST("app/upload")
    Observable<ResponseBean> upload(
            @Part MultipartBody.Part api_key,
            @Part MultipartBody.Part file,
            @Part MultipartBody.Part buildInstallType,
            @Part MultipartBody.Part buildPassword,
            @Part MultipartBody.Part buildUpdateDescription,
            @Part MultipartBody.Part buildName,
            @Part MultipartBody.Part buildInstallDate,
            @Part MultipartBody.Part buildInstallStartDate,
            @Part MultipartBody.Part buildInstallEndDate,
            @Part MultipartBody.Part buildChannelShortcut
    )
}